...
const ThemeImage = (props: Props) => {
  ...
  return (
    <>
      <Image {...rest} src={srcLight} className="h-10 w-auto dark:hidden" priority alt={rest.alt} />
      <Image {...rest} src={srcDark} className="hidden h-10 w-auto dark:block" priority alt={rest.alt} />
    </>
  );
};
